...
document.getElementById("infoText").textContent = "ustoz tori qildimmi?";

// document.querySelector("text").textContent = "hello if my cod is be good ";

document.getElementsByClassName("world").textContent =
  "i do not know what i need write so i write this text";
document.querySelectorAll("div").textContent = "jim tur ";
